...
<a href="https://npmcharts.com/compare/%40marcj%2Fts-clone-node?minimal=true"><img alt="Downloads per month" src="https://img.shields.io/npm/dm/%40marcj%2Fts-clone-node.svg"    /></a>
<a href="https://www.npmjs.com/package/%40marcj%2Fts-clone-node"><img alt="NPM version" src="https://badge.fury.io/js/%40marcj%2Fts-clone-node.svg"    /></a>
...
```
$ npm install @marcj/ts-clone-node
```

### Yarn

```
$ yarn add @marcj/ts-clone-node
```

### pnpm

```
$ pnpm add @marcj/ts-clone-node
```

### Peer Dependencies

`@marcj/ts-clone-node` depends on `typescript`, so you need to manually install this as well.
